...
- **보드 자동 인식**: Pico, Pico W, Pico 2, Pico 2 W, Waveshare RP2040-Zero, micro:bit V1/V2, 기타 MicroPython 장치 (상단 보드 이름을 눌러 직접 선택 가능)
- **새로 만들기**: 연결된 보드에 맞는 라이브러리를 import 하는 예제 (LED, PWM, ADC, 온도, 인터럽트, 타이머, 서보, I2C, NeoPixel, PIO, 듀얼코어, Wi-Fi / RP2040-Zero 내장 RGB LED(색상·무지개·숨쉬기), BOOT 버튼, 온도→색, UART, PIO WS2812 / 디스플레이, 버튼, 가속도, 나침반, 음악, 라디오, 마이크 등)
